...
```{r}
fits_0 <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part)
...
fits_3 <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part,trControl = tune_control, 
...
fits_4 <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part,trControl = tune_control,
...
fits_5 <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part,trControl = tune_control,
...
fits_final <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part,trControl = tune_control,
                tuneGrid = final_grid)
...
fits_final_f <- train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part,trControl = tune_control_f,
                tuneGrid = final_grid)
...
fits_ensemble <- lapply(models, function(model){ 
  print(model)
  train(Sales~as.factor(age)+as.factor(gender)+as.factor(interest)+Impressions+Clicks+Spent+Total_Conversion, method = "xgbTree", data = train_part)
}) 
...
predict_vote <- map_df(col_index, function(j){
  vote <- ifelse(test = sum(df[,j] == "Yes") > 2, yes = "Yes", no = "No")
